...
//    documentdictionary = [documentdictionary stringByAppendingPathComponent:@"imageCache/"];
//    
//    
...
//    [fileCache trimCacheUsingBackgroundThread];
    ...
    UINavigationController *nv = [[UINavigationController alloc]initWithRootViewController:hs];
    hs.title = @"HomeScreen";
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"PzVideoFilter" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PzVideoFilter.sqlite"];
